HASHCAT_ALGOS={
    ...
    "KeePass 1 (AES/Twofish) and KeePass 2 (AES) - keyfile only mode": 29700,
    ...
    "WBB4 (Woltlab Burning Board) Plugin [bcrypt(bcrypt($pass))]": 33800,
    ...
    "bcrypt-sha256 v2 bcrypt(HMAC-SHA256($pass))": 30601,
